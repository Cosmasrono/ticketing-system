...
class m250310_133801_create_ticket_table extends Migration
{
    public function safeUp()
    {
        $this->createTable('ticket', [
            ...
            'developer_id' => $this->integer()->defaultValue(null),
            'created_at' => $this->datetime()->defaultExpression('CURRENT_TIMESTAMP'),
            'assigned_to' => $this->integer()->defaultValue(null),
            'escalated_by' => $this->integer()->defaultValue(null),
            'escalated_to' => $this->integer()->defaultValue(null),
            'status' => "ENUM('pending','approved','cancelled','assigned','escalated','closed','reopen','reassigned') DEFAULT NULL",
